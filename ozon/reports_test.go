		...
		// Test Ok
		{
			...
			&GetShipmentReportParams{
				Filter: &GetShipmentReportFilter{
					...
					ProcessedAtFrom: core.NewTimeFormat(core.TimeFromString(t, "2021-09-02T17:10:54.861Z", "2006-01-02T15:04:05Z"), "2006-01-02T15:04:05Z"),
					ProcessedAtTo:   core.NewTimeFormat(core.TimeFromString(t, "2021-11-02T17:10:54.861Z", "2006-01-02T15:04:05Z"), "2006-01-02T15:04:05Z"),
				},
			},
			`{
				"result": {
